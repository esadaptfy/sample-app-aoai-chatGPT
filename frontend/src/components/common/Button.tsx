...
export const ShareButton: React.FC<ShareButtonProps> = ({onClick}) => {
    const shareButtonStyles: ICommandBarStyles & IButtonStyles = {
        root: {
          ...
          height: 32,
          borderRadius: 4,
          background: 'radial-gradient(109.81% 107.82% at 100.1% 90.19%, #E10600 33.63%, #E10600 70.31%, #E10600 100%)',
        //   position: 'absolute',
        //   right: 20,
          padding: '5px 12px',
          marginRight: '20px'
        ...
        rootHovered: {
          background: 'linear-gradient(135deg, #E10600 0%, #E10600 51.04%, #E10600 100%)',
        },
        label: {
          fontWeight: 600,
          fontSize: 14,
